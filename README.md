...
def dir_thresh(image, sobel_kernel=3, thresh=(0, np.pi/2)):
	...
	sobelx = cv2.Sobel(gray, cv2.CV_64F, 1, 0 ,ksize = sobel_kernel)sobely = cv2.Sobel(gray, cv2.CV_64F, 0, 1 ,ksize = sobel_kernel)
