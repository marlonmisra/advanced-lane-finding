...
abs_sobel_orient = 'x'
abs_sobel_kernel = 15
abs_sobel_threshold = (20,100)
mag_sobel_kernel = 3
mag_sobel_threshold = (60,100)
dir_sobel_kernel = 9
dir_sobel_threshold = (-np.pi/4,np.pi/4)
rgb_thresh_channel = 'r'
rgb_thresh_threshold = (0,100)
hls_thresh_channel = 's'
hls_thresh_threshold = (0,110)
...
#ALL TRANSFORMATIONS
progress = [images, undistorted_images, abs_sobel_thresh_images, mag_thresh_images, dir_thresh_images, rgb_thresh_images, hls_thresh_images, combined_images, windowed_images, birds_view_images]

#PLOT TRANSFORMATIONS
def plot_all(progress, test_image_number):
	labels = ['Original', 'Undistorted', 'Abs. Sobel Thresh.', 'Mag. Sobel Thresh.', 'Dir. Sobel Thresh.', 'RGB Thresh.', 'HLS Thresh.', 'Combined', 'Windowed', 'Birds view']
...
#lane_detections(birds_view_images[0])
